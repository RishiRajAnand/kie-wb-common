...
public class ProjectMetricsScreenTest extends AbstractDisplayerTest {
    ...
    public static class ContributorsData extends RawDataSet {
        ...
        public static final ContributorsData INSTANCE = new ContributorsData(
                new String[]{COLUMN_ORG, COLUMN_BRANCH, COLUMN_REPO, COLUMN_PROJECT, COLUMN_AUTHOR, COLUMN_DATE, COLUMN_MSG},
                new Class[]{String.class, String.class, String.class, String.class, String.class, Date.class, String.class},
                new String[][]{
                        {"org1","master",  "repo", "project1", "user1", "01/01/19 12:00", "Commit 1"},
                        {"org1","master", "repo", "project1", "user1", "03/02/19 12:00", "Commit 2"},
                        {"org1","master", "repo", "project1", "user2", "04/03/19 12:00", "Commit 3"},
                        {"org1","master", "repo", "project1", "user2", "06/04/19 12:00", "Commit 4"},
                        {"org2", "master","repo", "project2", "user3", "07/05/19 12:00", "Commit 5"},
                        {"org2","master", "repo", "project2", "user3", "09/06/19 12:00", "Commit 6"},
                        {"org2","master", "repo", "project2", "user4", "11/07/19 12:00", "Commit 7"},
                        {"org2","master", "repo", "project2", "user4", "02/08/20 12:00", "Commit 8"},
